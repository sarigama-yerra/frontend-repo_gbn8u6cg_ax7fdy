    ...
    <header className="fixed top-0 inset-x-0 z-30 backdrop-blur supports-[backdrop-filter]:bg-white/60 bg-white/80 border-b border-slate-200">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        <a href="#home" className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-lg bg-amber-500 text-white font-black flex items-center justify-center shadow">K</div>
          <span className="font-semibold text-slate-900 text-lg">Kaffeland</span>
        </a>
        <nav className="hidden md:flex items-center gap-8 text-slate-700">
          ...
          <a href="#contact" className="hover:text-slate-900">Get a demo</a>
          <a href="#contact" className="inline-flex items-center rounded-lg bg-amber-600 text-white px-4 py-2 font-medium hover:bg-amber-700 transition">Get started</a>
        </nav>
      ...
      {open && (
        <div className="md:hidden border-t border-slate-200 bg-white">
          <div className="px-4 py-3 flex flex-col gap-3">
            ...
            <a href="#machines" onClick={()=>setOpen(false)} className="py-2">Machines</a>
            <a href="#contact" onClick={()=>setOpen(false)} className="py-2">Get a demo</a>
          </div>
        </div>
      )}
    </header>
